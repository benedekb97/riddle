...
class RiddleController extends Controller
{
    ...
    {
        if(Auth::user()->solvedRiddles->contains($riddle) || Auth::user()->admin || Auth::user()->moderator || Auth::user()->activeRiddles->contains($riddle->id) || Auth::user()->riddles->contains($riddle)){
            $path = $riddle->image;
